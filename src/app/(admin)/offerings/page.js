...
export default function AdminProposals() {
  ...
  const tabs = [
    { id: "CreateOffer", name: "CreateOffer", component: CreateOffer },
    { id: "ActiveOffers", name: "Active Offers", component: ActiveOffers },
    { id: "CompletedOffers", name: "Completed Offers", component: CompletedOffers },
  ];
